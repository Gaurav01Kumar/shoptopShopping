							...
							<div class="transfers">
								<div class="transfer">
									<div class="transfer-logo">
										<img src="images/arrivals/Men/men1.jpg" />
									</div>
									<dl class="transfer-details orders-text">
										<div>
											<dt>Rider Devil Biker T-shirt</dt>
										</div>
										<div>
											<dt><strong>Color : </strong>Red</dt>
											<dd><strong>Size :</strong> S</dd>
                                            <dd><strong>Mode of Payment : </strong>Cash</dd>
										</div>
										<div>
											<dd><strong>Shipping Address : </strong>645, Jagannath Shanker Shet Rd, Near Metro Cinema,dhobi T, Kalbadevi</dd>
										</div>
                                        <div>
                                            <dt><strong>Payment Pending : </strong><br/>Rs. 350</dt>
                                        <dt><button>Cancel Order</button></dt>
                                        </div>
									</dl>
								...
								<div class="transfer">
									<div class="transfer-logo">
										<img src="images/arrivals/Men/men2.jpg" />
									</div>
									<dl class="transfer-details orders-text">
                                        <div>
											<dt>Running Athlete T-shirt</dt>
										</div>
                                        <div>
											<dt><strong>Color : </strong>Yellow</dt>
											<dd><strong>Size :</strong> M</dd>
                                            <dd><strong>Mode of Payment : </strong>UPI/Credit/Debit/Online</dd>
										</div>
										<div>
											<dd><strong>Shipping Address : </strong>Shop No 2 Madhu Kalpana, Shradhanand Rd, Vile Parle (east)</dd>
										</div>
                                        <div>
                                            <dt><strong>Payment Received : </strong><br/>Rs. 445</dt>
                                        <dt><button>Cancel Order</button></dt>
                                        </div>
									</dl>
								</div>
								<div class="transfer">
									<div class="transfer-logo">
										<img src="images/arrivals/Men/men3.jpg" />
									</div>
									<dl class="transfer-details orders-text">
										<div>
										...
										<div>
											<dt><strong>Color : </strong>White</dt>
											<dd><strong>Size :</strong> XL</dd>
                                            <dd><strong>Mode of Payment : </strong>UPI/Credit/Debit/Online</dd>
										</div>
										<div>
											<dd><strong>Shipping Address : </strong> Court Chambers, S V Road, Next To Rasoi Hotel, Borivli(w)</dd>
										</div>
                                        <div>
                                            <dt><strong>Payment Received : </strong><br/>Rs. 299</dt>
                                        <dt><button>Cancel Order</button></dt>
                                        </div>
									</dl>
								</div>
