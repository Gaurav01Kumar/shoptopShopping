					...
					<div class="app-body-main-content">
						...
						<section class="transfer-section">
							<div class="transfer-section-header">
								<h2>All Products</h2>
								<button>
									<Link to="/NewProduct">Add New</Link></button>
							</div>
							<div class="transfers">
								<div class="transfer">
									...
									<dl class="transfer-details">
										...
										<div>
											<dt><strong>Color : </strong>Red, Blue, Green, Black, White.</dt>
											<dd><strong>Size :</strong> S,M,XL,XXL</dd>
										</div>
										<div>
											<dt><button>Edit Product</button></dt>
											<dd><button>Delete Product</button></dd>
										</div>
									</dl>
